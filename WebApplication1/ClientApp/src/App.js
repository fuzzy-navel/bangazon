...
import Departments from './components/Departments/AllDepartments/Departments';
import Employees from './components/Employees/Employees';
import PaymentTypes from './components/PaymentTypes/AllPayments/PaymentTypes';
import OnePaymentType from './components/PaymentTypes/SinglePayment/OnePaymentType';
import AddPayments from './components/PaymentTypes/AddPayment/AddPaymentType';
import UpdatePay from './components/PaymentTypes/UpdatePaymentType/UpdatePay';
import Products from './components/Products/AllProducts/AllProducts';
